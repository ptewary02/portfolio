...
export default function Hero() {
  return (
    ...
    <section className="mt-8 mb-8 md:mt-32 flex flex-col md:flex-row items-center justify-between md:py-section-gap gap-8 sm:gap-10 md:gap-15 mx-2 sm:mx-4 md:mx-8 pt-8 md:pt-0" id="home">
