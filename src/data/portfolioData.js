...
export const skills = [
  { category: "Languages", items: ["JavaScript (ES6+)", "C++", "HTML5", "CSS3"] },
  { category: "Frontend Frameworks/Libraries", items: ["React.js", "Tailwind CSS", "Redux Toolkit"] },
  { category: "Backend & Databases", items: ["Node.js", "Express.js", "MongoDB", "REST APIs"] },
  { category: "Tools & Developer Utilities", items: ["Git", "GitHub", "Postman", "Vite", "VS Code"] }
];

export const links = 
  {
    github: "https://github.com/ptewary02",
    linkedin: "https://www.linkedin.com/in/pravesh-tewary-2a0ba5294/",
    x: "https://x.com/p_tewary02",
    instagram: "https://www.instagram.com/p_tewary02/",
    email: "pravesh.tewary21@gmail.com",
  };